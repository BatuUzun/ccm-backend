...
public class EmailSenderService {
	...
	private String SEND_EMAIL_FROM = "ccmhackathon@gmail.com";
	...
	public int changePasswordCodeEmailSender(String email, int code) {
		...
		final String EMAIL_SUBJECT = "Reset Your CCM Password";
	    final String EMAIL_BODY = "Dear User,\n\n" +
	                              "We received a request to reset the password for your CCM account. " +
